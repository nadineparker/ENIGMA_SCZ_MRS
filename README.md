...
Download and unzip the ``ENIGMA_SCZ_PRS.zip`` directory from figshare (TBD). All necessary project files are located in that directory. NOTE: some files are large, therefore, (1) this download will take time (hours) and (2) we recommend having ~25GB of free space on your system.
